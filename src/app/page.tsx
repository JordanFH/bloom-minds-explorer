  ...
  return (
    ...
    >
      <div className="bg-gradient-to-br from-emerald-50/95 via-lime-200/95 to-green-300/95">
        ...
        <section className="pt-32 pb-20 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center mb-12">
              <Badge className="bg-cyan-700 hover:bg-cyan-800 text-white">
                NASA Space Apps Challenge 2024
              </Badge>
              <h1 className="text-5xl md:text-7xl font-bold mb-6 text-balance leading-tight">
                NASA Space Apps Challenge 2024 · bloomMinds
              </h1>
              <p className="text-xl md:text-2xl text-muted-foreground mb-8 text-pretty leading-relaxed">
                ...
                <b>Bloom Explorer</b> o aprende sobre floración y vegetación en los{" "}
                <b>Bloom Quiz.</b>
              </p>
        ...
        {/* Challenge Section */}
        <section id="challenge" className="py-20 bg-black text-white map-with-starry-bg">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <Card className="p-8 md:p-12 bg-card border-border">
                ...
                <p className="text-lg leading-relaxed text-muted-foreground">
                  Our challenge is to harness the power of NASA Earth observations to create a
                  dynamic visual tool that displays and detects plant blooming events around the
                  globe—just like pollinators do—and that advances solutions for monitoring,
                  predicting, or managing vegetation.
                </p>
              </Card>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground text-pretty">
                Bloom Minds Explorer is an interactive 3D globe visualization platform that
                leverages NASA GIBS data to track vegetation changes and blooming events in
                real-time
              </p>
            </div>
